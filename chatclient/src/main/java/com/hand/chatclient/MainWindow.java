...
//		ip.setColumns(10);
//		
//		JButton jButton = new JButton("连接到服务器");
//				
...
//		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup().addg));
//		
